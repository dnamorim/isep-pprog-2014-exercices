...
public class Cliente extends Pessoa {
     ...
     */
    public Cliente(String nome, char sexo, int idade, int nif, int nrCliente, float altura, float peso) {
     ...
     */
    public Cliente() {
        this(Pessoa.NOME_POR_DEFEITO, Pessoa.SEXO_POR_DEFEITO, Pessoa.IDADE_POR_DEFEITO, Pessoa.NIF_POR_DEFEITO, Cliente.NRCLIENTE_POR_DEFEITO, Cliente.ALTURA_POR_DEFEITO, Cliente.PESO_POR_DEFEITO);
    }
    ...
    public Cliente(Cliente outroCliente) {
        this(outroCliente.getNome(), outroCliente.getSexo(), outroCliente.getIdade(), outroCliente.getNif(), outroCliente.getNrCliente(), outroCliente.getAltura(), outroCliente.getPeso());
    }
    ...
    public String toString() {
        return String.format("%s%nNr. Cliente: %d  Altura: %.2f m  Peso: %.2f kg", super.toString(), this.nrCliente, this.altura, this.peso);
    }
    ...
    public boolean equals(Object outroObjecto) {
        ...
        return (this.nrCliente == c.getNrCliente() && this.altura == c.getAltura() && this.peso == c.getPeso());
    }
