...
public class ClienteConvidado extends Cliente {
    ...
    public ClienteConvidado() {
       this(Pessoa.NOME_POR_DEFEITO, Pessoa.SEXO_POR_DEFEITO, Pessoa.IDADE_POR_DEFEITO, Pessoa.NIF_POR_DEFEITO, Cliente.NRCLIENTE_POR_DEFEITO, Cliente.ALTURA_POR_DEFEITO, Cliente.PESO_POR_DEFEITO, ClienteConvidado.NRHORAS_POR_DEFEITO); 
    }
    ...
    public ClienteConvidado(ClienteConvidado outroConvidado) {
        this(outroConvidado.getNome(), outroConvidado.getSexo(), outroConvidado.getIdade(), outroConvidado.getNif(), outroConvidado.getNrCliente(), outroConvidado.getAltura(), outroConvidado.getPeso(), outroConvidado.getNrHoras());
    } 
    ...
    public String toString() {
        return String.format("Convidado:%n%s%nNº Horas Disponíveis: %d", super.toString(), this.nrHoras);
    }
