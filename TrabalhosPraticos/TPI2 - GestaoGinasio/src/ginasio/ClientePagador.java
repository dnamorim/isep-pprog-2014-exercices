...
public abstract class ClientePagador extends Cliente {
     ...
     */
    public ClientePagador(String nome, char sexo, int idade, int nif, int nrCliente, float altura, float peso, int estado) {
        super(nome, sexo, idade, nif, nrCliente, altura, peso);
        this.estado = estado;
    }
    ...
    public ClientePagador() {
        this(Pessoa.NOME_POR_DEFEITO, Pessoa.SEXO_POR_DEFEITO, Pessoa.IDADE_POR_DEFEITO, Pessoa.NIF_POR_DEFEITO, Cliente.NRCLIENTE_POR_DEFEITO, Cliente.ALTURA_POR_DEFEITO, Cliente.PESO_POR_DEFEITO, ClientePagador.ESTADO_POR_DEFEITO);
    }
    ...
    public ClientePagador(ClientePagador outroClientePag) {
        this(outroClientePag.getNome(), outroClientePag.getSexo(), outroClientePag.getIdade(), outroClientePag.getNif(), outroClientePag.getNrCliente(), outroClientePag.getAltura(), outroClientePag.getPeso(), outroClientePag.getEstado());
    }
    ...
    public String toString() {
        return String.format("%s%nEstado: %s (%d)", super.toString(), (this.estado == 1) ? "Activo" : "Inactivo", this.estado);
    }
    ...
    /**
     * Devolve o valor a pagar por um Cliente Pagador ao ginásio
     * @return valor a pagar 
     */
    public abstract float valorPagamentoCliente();
