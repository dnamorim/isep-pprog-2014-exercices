 ...
 */
public class Treinador extends Pessoa implements Trabalhador, Recebimento {
     ...
     */
    public Treinador(String nome, char sexo, int idade, int nif, float salario) {
     ...
     */
    public Treinador() {
        this(Pessoa.NOME_POR_DEFEITO, Pessoa.SEXO_POR_DEFEITO, Pessoa.IDADE_POR_DEFEITO, Pessoa.NIF_POR_DEFEITO, Treinador.SALARIO_POR_DEFEITO);
    }
    ...
    public Treinador(Treinador outroTreinador) {
        this(outroTreinador.getNome(), outroTreinador.getSexo(), outroTreinador.getIdade(), outroTreinador.getNif(), outroTreinador.getSalario());
    }
    ...
    public String toString() {
        return String.format("Treinador:%n%s%nSalário: %.2f €%n", super.toString(), this.salario);
    }
