 ...
 */
public class ClienteRegular extends ClientePagador {
    ...
    public ClienteRegular() {
        this(Pessoa.NOME_POR_DEFEITO, Pessoa.SEXO_POR_DEFEITO, Pessoa.IDADE_POR_DEFEITO, Pessoa.NIF_POR_DEFEITO, Cliente.NRCLIENTE_POR_DEFEITO, Cliente.ALTURA_POR_DEFEITO, Cliente.PESO_POR_DEFEITO, ClientePagador.ESTADO_POR_DEFEITO, ClienteRegular.MENSALIDADE_POR_DEFEITO);
    }
    ...
    public ClienteRegular(ClienteRegular outroClienteRegular) {
        this(outroClienteRegular.getNome(), outroClienteRegular.getSexo(), outroClienteRegular.getIdade(), outroClienteRegular.getNif(), outroClienteRegular.getNrCliente(), outroClienteRegular.getAltura(), outroClienteRegular.getPeso(), outroClienteRegular.getEstado(), outroClienteRegular.getMensalidade());
    } 
    ...
    public String toString() {
        return String.format("Cliente Regular:%n%s%nMensalidade: %.2f €", super.toString(), this.mensalidade);
    }
