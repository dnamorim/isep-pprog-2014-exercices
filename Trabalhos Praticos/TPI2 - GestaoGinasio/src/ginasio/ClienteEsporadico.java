 ...
 */
public class ClienteEsporadico extends ClientePagador {
    ...
    public ClienteEsporadico(String nome, char sexo, int idade, int nif, int nrCliente, float altura, float peso, int estado, int horasSessao) {
        super(nome, sexo, idade, nif, nrCliente, altura, peso, estado);
    ...
    public ClienteEsporadico() {
        this(Pessoa.NOME_POR_DEFEITO, Pessoa.SEXO_POR_DEFEITO, Pessoa.IDADE_POR_DEFEITO, Pessoa.NIF_POR_DEFEITO, Cliente.NRCLIENTE_POR_DEFEITO, Cliente.ALTURA_POR_DEFEITO, Cliente.PESO_POR_DEFEITO, ClientePagador.ESTADO_POR_DEFEITO, ClienteEsporadico.HORASSESSAO_POR_DEFEITO);
    }
    ...
    public ClienteEsporadico(ClienteEsporadico outroClienteEsporadico) {
        this(outroClienteEsporadico.getNome(), outroClienteEsporadico.getSexo(), outroClienteEsporadico.getIdade(), outroClienteEsporadico.getNif(), outroClienteEsporadico.getNrCliente(), outroClienteEsporadico.getAltura(), outroClienteEsporadico.getPeso(), outroClienteEsporadico.getEstado(), outroClienteEsporadico.getHorasSessao());
    }
    ...
    public String toString() {
        return String.format("Cliente Esporádico:%n%s%nHoras de Sessão: %d h", super.toString(), this.horasSessao);
    }
     ...
     */
    @Override
    public float valorPagamentoCliente() {
